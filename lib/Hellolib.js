...
function (_React$Component) {
  _inherits(HelloLib, _React$Component);

  function HelloLib(props) {
    var _this;

    _classCallCheck(this, HelloLib);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(HelloLib).call(this, props));
  ...
  _createClass(HelloLib, [{
    ...
    value: function render() {
      return _react["default"].createElement("div", null, " ", _react["default"].createElement("h1", null, "Updated Moudule"), _react["default"].createElement(_reactstrap.Form, {
